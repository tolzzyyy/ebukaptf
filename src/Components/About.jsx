...
const About = () => {
  return (
    <div className="px-[30px] max-w-[1740px] mx-auto lg:px-[40px] xl:px-[65px] 2xl:px-[100px] about flex flex-col justify-center mt-[50px] xl:my-[20px] items-center min-h-[400px] xl:h-[100vh]">
      <div className="flex flex-col md:flex-row items-center w-full lg:justify-between gap-[40px] md:gap-8">
        ...
        <div className=" w-auto md:w-[690px] xl:w-[740px]  2xl:w-[740px] font-[400] leading-[1.7] text-[9.3px] md:text-[9px] lg:text-[9px] xl:text-[14px] 2xl:text-[15px] flex flex-col gap-[20px] md:gap-4 xl:gap-4 2xl:gap-9">
