...
const About = () => {
  return (
    <div>
      <div className="  px-[30px] max-w-[1640px] mx-auto lg:px-[40px] xl:px-[65px] about flex flex-col  justify-center my-[20px] xl:my-0   items-center min-h-[400px] xl:h-[100vh] ">
