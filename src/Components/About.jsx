...
const About = () => {
  return (
    <div>
      <div className="  px-[30px] lg:px-[40px] xl:px-[65px] about flex flex-col md:flex-row justify-center my-[50px]  xl:my-0 items-center min-h-[500px] xl:h-[100vh] ">
      <div className="flex flex-col lg:flex-row min-h-[100vh] items-center w-full  lg:justify-between 2xl:justify-center 2xl:gap-[200px] gap-[40px] md:gap-8">
          ...
          <div className="w-auto  lg:w-[767px] 2xl:w-[600px] font-[400] leading-[13.6px] lg:leading-[normal] 2xl:text-[12px]   text-[8.2px] md:text-[10px] lg:text-[8px] xl:text-[14px] flex flex-col gap-[30px] md:gap-7 xl:gap-8">
            <h1>
