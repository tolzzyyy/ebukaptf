  ...
  return (
    <div>
      ...
      <div className="flex flex-col lg:flex-row min-h-[100vh] items-center w-full  lg:justify-between gap-[40px] md:gap-8">
          ...
          <div className="w-auto  lg:w-[767px] 2xl:w-[600px] font-[400] leading-[13.6px] lg:leading-{20.4px}   text-[8.2px] md:text-[10px] lg:text-[8px] xl:text-[14px] flex flex-col gap-[30px] md:gap-7 xl:gap-8">
            <h1>
