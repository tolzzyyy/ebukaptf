    ...
    <div className="px-[30px] max-w-[1640px] mx-auto lg:px-[40px] xl:px-[65px] 2xl:px-[100px] about flex flex-col justify-center my-[20px] xl:my-[20px] items-center min-h-[400px] xl:h-[100vh]">
      <div className="flex flex-col lg:flex-row items-center w-full lg:justify-between gap-[40px] md:gap-8">
        ...
        <div className="w-auto xl:w-[740px]  2xl:w-[730px] font-[400] leading-[1.5] text-[8.3px] md:text-[10px] lg:text-[10px] xl:text-[14px] flex flex-col gap-[30px] md:gap-4 xl:gap-4 2xl:gap-8">
          ...
          <h1>
            If you’ve gotten this far, I now consider us friends. It’s nice to
            meet you! I'm a motion and visual designer passionate about creating
            visuals that tell stories and designing brand experiences that
            improve everyday lives. I love bold colors, textures, and expressive
            copywriting! I’m an ISMS Major at something University and currently
            interning with the wonderful design & marcom team at Apple.
          </h1>
          <h1>
            Creating art is another true love whether it’s traditional or
            digital. You can sometimes find me sketching in Procreate. As a fresh
            graduate of Information Science & Media Studies from Pan Atlantic
            University, I want to share my skills and all-round enthusiasm with a
            new team. If you ever want to chat or have a position or a project
            that could benefit from my creativity & style,{" "}
            <a className="underline" href="mailto:Eburogersuche@yahoo.com">
              let's talk!
            </a>{" "}
      ...
      <div className="border-t-[1px] flex flex-col items-center w-full gap-10 justify-center py-8 md:py-12 mt-[50px] h-auto border-black mx-[20px] lg:mx-[40px] xl:mx-[65px]">
